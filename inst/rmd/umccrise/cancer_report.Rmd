...
if (!is.null(params$chord_file)) {
  ...
  prediction = convert_json_gz_to_tibble(args$chord_file)
    )
}
...
if (!is.null(params$mutpat_dir)) {
  ...
  sigs_snv_2015_tsv <- gpgr::read_jsongz(file.path(params$mutpat_dir, glue::glue("snv_2015.json.gz")))
  sigs_snv_2020_tsv <- gpgr::read_jsongz(file.path(params$mutpat_dir, glue::glue("snv_2020.tjsonsv.gz")))
  sigs_dbs_tsv     <- gpgr::read_jsongz(file.path(params$mutpat_dir, glue::glue("dbs.json.gz")))
  sigs_indel_tsv    <- gpgr::read_jsongz(file.path(params$mutpat_dir, glue::glue("indel.json.gz")))
