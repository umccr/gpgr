...
# NOTE(QC): samples are considered hypermutated if they have more than 500k raw
# DRAGEN variants. Using $dragen (not $annotated) because the hypermutation filter
# runs before annotation, so $annotated is already reduced for hypermutated samples.
hypermutated <- snv_summary_counts$dragen > 500000
