...
qc_summary_all <- dplyr::tribble(
  ...
  6, "HRD", glue::glue("DRAGEN: {hrd_summary$dragen}; HRDetect: {hrd_summary$hrdetect}"),
  "Homologous recombination deficiency score (DRAGEN) / probability (HRDetect).",
...
hrd_results <- gpgr::hrd_results_tabs(hrdetect_res, NULL, dragen_hrd_res)
