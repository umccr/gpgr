...
excel <- readxl::read_excel("~/Downloads/old vs new signatures recent cases_LZ.xlsx", skip = 1) %>%
  dplyr::select("EXTERNAL SUBJECT ID", "SUBJECT ID") %>%
  dplyr::filter(!is.na(`EXTERNAL SUBJECT ID`))
