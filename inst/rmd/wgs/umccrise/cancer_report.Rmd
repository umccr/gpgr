...
sigs_snv_2020 <-
  MutationalPatterns::get_known_signatures(muttype = "snv", incl_poss_artifacts = TRUE) %>%
  gpgr::sig_contribution(mut_mat = mp_snv$snv_counts, signatures = .)
sigs_dbs <-
...
gpgr::write_tsvjsongz(sigs_snv_2015, "sigs/snv_2015", result_outdir)
gpgr::write_tsvjsongz(sigs_snv_2020, "sigs/snv_2020", result_outdir)
gpgr::write_tsvjsongz(sigs_dbs, "sigs/dbs", result_outdir)
gpgr::write_tsvjsongz(sigs_indel, "sigs/indel", result_outdir)
```
...
gpgr::write_tsvjsongz(qc_summary_all, "qc_summary", result_outdir)
```
...
### __SNV__ Signatures {.tabset .tabset-fade #signatures}
...
```{r mp_snv_plots, out.width="90%", fig.width=16, fig.height = 10}
...
```{r mutationalpatterns_strand_bias, out.width="90%", fig.width=12, fig.height=10}
## ---- Transcriptional ---- ##
...
### __SNV__ Signature Contribution {.tabset .tabset-fade #contributions}
...
### __INDEL/DBS__ Signatures {.tabset .tabset-fade #signatures2}
