...
#---- PURPLE CNV Tables ----#
purple_cnv_som <- gpgr::purple_cnv_somatic_process(params$purple_som_cnv)
purple_cnv_som_gene <- gpgr::purple_cnv_gene_process(params$purple_som_gene_cnv, params$key_genes)
purple_cnv_germ <- gpgr::purple_cnv_somatic_process(params$purple_germ_cnv)
```
...
if (will_work) {
  MutationalPatterns::plot_rainfall(somatic_snv[[1]], chromosomes = GenomeInfoDb::seqnames(base::get(ref_genome))[1:22], cex = 1.2, ylim = 1e+09)
}
```
