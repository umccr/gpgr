...
params_tmp <- list(
  ...
  local = list(
    ...
    purple_gene_cnv=glue::glue('{dd}/data/umccrised/work/{batch_name}/purple/{batch_name}.purple.cnv.gene.tsv'),
    purple_cnv=glue::glue('{dd}/data/umccrised/work/{batch_name}/purple/{batch_name}.purple.cnv.somatic.tsv'),
...
purple_cnv_gene <- gpgr::purple_cnv_gene_process(params$purple_gene_cnv, params$key_genes)
```

```{r purple_cnv_somatic_prep}
#---- PURPLE Global CNV Table ----#
purple_cnv_somatic <- gpgr::purple_cnv_somatic_process(params$purple_cnv)
```
