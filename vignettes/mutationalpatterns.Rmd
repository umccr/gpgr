...
sigs_snv_2015 %>%
  gpgr::sig_contribution_table(type = "Sig", outdir = "out1") %>%
  knitr::kable(format = "html") %>%
  kableExtra::kable_styling(c("hover", "striped"), font_size = 12) %>%
  kableExtra::scroll_box(height = "400px")

sigs_snv_2020 %>%
  gpgr::sig_contribution_table(type = "SBS", outdir = "out1") %>%
  knitr::kable(format = "html") %>%
  kableExtra::kable_styling(c("hover", "striped"), font_size = 12) %>%
  kableExtra::scroll_box(height = "400px")
```
...
sigs_dbs %>%
  gpgr::sig_contribution_table(type = "DBS", outdir = "out1") %>%
  knitr::kable(format = "html") %>%
  kableExtra::kable_styling(c("hover", "striped"), font_size = 12) %>%
  kableExtra::scroll_box(height = "400px")
```
...
sigs_indel %>%
  gpgr::sig_contribution_table(type = "ID", outdir = "out1") %>%
  knitr::kable(format = "html") %>%
  kableExtra::kable_styling(c("hover", "striped"), font_size = 12) %>%
  kableExtra::scroll_box(height = "400px")
```
