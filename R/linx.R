LINX_DESCRIPTIONS <- tibble::tribble(
  ...
  "links", "lowerSvId", "c", "svId of the leftmost breakend of the linked segment",
  "links", "upperSvId", "c", "svId of the rightmost breakend of the linked segment",
  ...
  "drivercatalog", "transcript", "c", "Transcript name",
  "drivercatalog", "isCanonical", "c", "Is canonical",
